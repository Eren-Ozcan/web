  ...
  const imageData = [
    {
      ...
      hotspots: [
        { x: 15, y: 20, label: '1', route: '/products/glass', tooltip: t('glass') },
        { x: 30, y: 40, label: '2', route: '/products/doors', tooltip: t('door') },
        { x: 60, y: 45, label: '3', route: '/products/balkon', tooltip: t('balcony') }
      ]
    },
    {
      image: '/images/house2.jpg',
      hotspots: [
        { x: 20, y: 30, label: '4', route: '/products/bahce', tooltip: t('garden') },
        { x: 45, y: 55, label: '5', route: '/products/office', tooltip: t('office') },
        { x: 70, y: 65, label: '6', route: '/products/facade', tooltip: t('exterior') }
      ]
    }
  ];
